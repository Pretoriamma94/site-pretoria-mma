...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'L\u2019adhésion annuelle va de 200 à 300 € selon le cours : Baby JJB 200 €, enfants et adolescents 250 €, forfait femmes 200 € (tous les cours adultes mixtes + créneau femmes), adultes mixte 300 € (hommes). Le règlement se fait au club en espèces ou chèque (1, 2 ou 3 fois), ou en ligne via HelloAsso (paiement en une fois ou en plusieurs fois). L\u2019inscription se fait en ligne depuis la page S\u2019inscrire.',
  },
];
