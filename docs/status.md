...
- **Pass Sport** : case à cocher **uniquement pour les −18 ans**. Aide de l’État **non déduite** de la cotisation (finances club inchangées). Code promo **PASSPORT** à saisir sur HelloAsso en paiement en ligne ; espèces / chèque : se rapprocher du club. Preuve (PDF/JPG/PNG) ou engagement 3 semaines. Admin : badge **Pass Sport**, bannière de délai, upload de la preuve. Migration `20260913190000_pass_pa2s.sql` à appliquer sur le remote.
